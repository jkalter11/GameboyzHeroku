...
class resetpassword2_PA (unittest.TestCase):
...
#This is the method used to test the reset password fucntion on the website
   def test_resetpassword2_PA(self):
       #Set up Variables
       user = "admin"
       pwd = "eb708199"
       driver = self.driver
       ...
       driver.get("http://ebrousseau.pythonanywhere.com/reset/MQ/517-ec10f926cfc05a221648/")
       time.sleep(3)
       ...
       time.sleep(5)
       driver.get("http://ebrousseau.pythonanywhere.com/reset/done/") #This page tells you that the reset password has been complete
       elem = driver.find_element_by_xpath("/html/body/div/p/a") #Clicks on the login again hyperlink
       driver.get("http://ebrousseau.pythonanywhere.com/login/") #Takes you to the login screen
       time.sleep(3)
